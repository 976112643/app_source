package com.wq.support.utils.log;
...
final class LoggerPrinter implements Printer {
  ...
  private static final String DEFAULT_TAG = "weiquan";
  ...
  private String formatTag(String tag) {
    if (!Helper.isEmpty(tag) && !Helper.equals(this.tag, tag)) {
      ...
      return this.tag+"-"+getClassNameAsTag();
    }
//    return this.tag;
  }
	/**
	 ...
	 * @return
	 */
	private  String getClassNameAsTag() {
		StackTraceElement[] trace = new Throwable().fillInStackTrace().getStackTrace();
		String callingClass = "";
        int stackOffset = getStackOffset(trace) + settings.getMethodOffset();
		for (int i = stackOffset; i < trace.length; i++) {
