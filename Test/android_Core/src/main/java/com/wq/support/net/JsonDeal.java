...
public class JsonDeal {
	 ...
	 * @return
	 */
	public static BaseBean createBean(String json, Type clazz) {
		JSONObject jobj = createJsonObj(json);
		BaseBean bean = new BaseBean();
		dealDefBean(bean, jobj);
		Object obj = jobj.has(INFO) ? jobj.opt(INFO) : json;
