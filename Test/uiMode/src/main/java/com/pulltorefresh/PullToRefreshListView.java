...
public class PullToRefreshListView extends
	...
	public void isBelongScroll(boolean isBelongScroll) {
		this.isBelongScroll = isBelongScroll;
	}

	boolean isBelongScroll = false;
	public PullToRefreshListView(Context context,
			com.pulltorefresh.PullToRefreshBase.Mode mode,
			com.pulltorefresh.PullToRefreshBase.AnimationStyle style) {
	...
	protected class InternalListView extends ListView implements
		...
		protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
			if (PullToRefreshListView.this.isBelongScroll) {
