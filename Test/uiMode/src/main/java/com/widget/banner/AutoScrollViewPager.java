...
public class AutoScrollViewPager extends ViewPager {
	...
	private void setViewPagerScroller() {
		try {
			...
			scroller = new CustomDurationScroller(getContext(), (Interpolator) interpolatorField
					.get(null));
	...
	public void scrollOnce() {
		...
		int totalCount;
		if (adapter == null || (totalCount = adapter.getCount()) <= 1) { return; }
	...
	class CustomDurationScroller extends Scroller {
		 ...
		 */
		// @SuppressLint("NewApi")
		// public CustomDurationScroller(Context context, Interpolator
		// interpolator, boolean flywheel){
