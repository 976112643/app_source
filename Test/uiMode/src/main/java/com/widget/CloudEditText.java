...
public class CloudEditText extends EditText {
    ...
    private void init() {
        ...
        drawablePadding = UiUtils.dp2px(getContext(),10);
        itemPadding = UiUtils.dp2px(getContext(),3);
...
//            System.out.println("start:"+start+";end:"+end);
    ...
    private BitmapDrawable drawImageSpan(int measuredWidth, String spanText) {
        ...
        textPaint.setTextSize(UiUtils.dp2px(getContext(),(int) getTextSize()));
        textPaint.getTextBounds(spanText, 0, spanText.length()+10, textRect);
        int textPadding = UiUtils.dp2px(getContext(),6);
...
//        view.setBackgroundResource(R.drawable.selec_btn_cancel);
