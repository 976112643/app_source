...
//	}
	...
	public ViewFillterEnhance setBackgroundURL(final int viewId, String url) {
		ImageLoader.getInstance().loadImage(url, ImageLoadOptions.getDefaultOption(), new SimpleImageLoadingListener() {

			@Override
			public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
				super.onLoadingComplete(imageUri, view, loadedImage);
				getView(viewId).setBackgroundDrawable(new BitmapDrawable(loadedImage));
			}
		});
		return this;
	}
	 ...
	 * 为ImageView设置网络图片
	 */
	public ViewFillterEnhance setImageURL(int viewId, String url) {
		ImageLoader.getInstance().displayImage(url, (ImageView) getView(viewId), ImageLoadOptions.getDefaultOption());
		return this;
	}
