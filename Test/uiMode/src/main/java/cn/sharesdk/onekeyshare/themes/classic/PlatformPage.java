...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public static OnClickListener lins;
...
//			View bottomLay = View.inflate(activity,
//					com.qiyu.naoke.R.layout.dialog_share_bottom, null);
//			if (lins == null) {
//				View zhuanfa=bottomLay.findViewById(com.qiyu.naoke.R.id.zhuanfa);
//				zhuanfa.setVisibility(View.GONE);
//			}
//			llPanel.addView(bottomLay);
//
//			bottomLay.findViewById(com.qiyu.naoke.R.id.cancel)
...
//						}
//					});
//			bottomLay.findViewById(com.qiyu.naoke.R.id.zhuanfa)
//					.setOnClickListener(new OnClickListener() {
//
//						@Override
//						public void onClick(View v) {
...
//					});
		...
		// LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,UiUtils.dp2px(activity,
		// 40));
		// View view=new View(activity);
		// view.setBackgroundColor(activity.getResources().getColor(R.c));
		// llPanel.addView(child, params);
